...
public class AdpcmCompression implements IGenericCompression {
    ...
    public static final int WRITE_CURRENT_VALUE_MAGNITUDE = 0;
    public static final int ADVANCE_PERIOD_MAGNITUDE = 1;
    public static final int ADVANCE_CHANNEL_MAGNITUDE = 2;
    ...
    private final int SIGN_FLAG = 0x80;
    private final int MAGNITUDE_FLAG = 0x7F;
    private final int DIRECTION_FLAG = 0x40;
    private final int STEP_CHANGE_FLAG = 0x1F;
